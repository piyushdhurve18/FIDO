...
def create_cbor_setpin_protocol1(new_pin_enc, pin_auth, key_agreement):
    ...
    apdu = "80108000" + format(length, '02X') + "06" + data_cbor
    return apdu
...
def setpin(pin):
    ...
    util.APDUhex("00a4040008a0000006472f0001", "Select Applet")
    util.APDUhex("80108000010700", "Reset Card PIN (optional)")
...
def createCBORchangePIN_protocol2_temp(pinHashEnc, newPINenc, pinAuth, keyAgreement):
    """
...
def getPINtokenPubkey1_2_2(pin):
    util.APDUhex("00a4040008a0000006472f0001", "Select applet")
    util.APDUhex("80100000010400", "GetInfo")
